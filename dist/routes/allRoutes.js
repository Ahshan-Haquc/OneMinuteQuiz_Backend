...
const { login, signupDefault, signup } = require("../controllers/userController");
...
//logout route
router.get("/logout", userAccessPermission, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield User.findById(req.userInfo._id);
        if (!user) {
...
router.post("/feedback", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// load dashboard data
router.get("/loadAdminDashboardValues", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const ratingCount = { 5: 0, 4: 0, 3: 0, 2: 0, 1: 0 };
        const users = yield User.find({ role: "user" });
        const userFeedbacks = yield UserFeedback.find({});
        ...
        const totalFeedbacks = ratingCount[5] +
            ...
            ratingCount[2] +
            ratingCount[1];
        const averageRating = totalFeedbacks === 0 ? 0 : (totalRatings / totalFeedbacks).toFixed(2);
        res.status(200).json({
            users,
            userFeedbacks,
            userCount,
...
//delete user
router.post("/deleteUser", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = new mongoose.Types.ObjectId(req.body.userId);
        yield User.deleteOne({ _id: userId });
        const newUsers = yield User.find({});
...
router.post("/deleteFeedback", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userFeedbackId = new mongoose.Types.ObjectId(req.body.userFeedbackId);
        yield UserFeedback.deleteOne({ _id: userFeedbackId });
        const newFeedback = yield UserFeedback.find({});
